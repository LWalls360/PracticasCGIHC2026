...
int main() {
 ...
 //     
	...
	glm::mat4 projection=glm::mat4(1); // Declaración de matriz 4*4
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::mat4(1);
		model = glm::rotate(model, 0.7f, glm::vec3(1.0f, 1.0f, 3.0f)); // use to compare orthographic and perspective projection
		...
		model = glm::mat4(1);
		model = glm::rotate(model, 0.9f, glm::vec3(3.0f, 0.0f, 0.0f)); // use to compare orthographic and perspective projection
